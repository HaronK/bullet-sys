...
pub struct btVector3 {
    pub __bindgen_anon_1: btVector3__bindgen_ty_1,
}
#[repr(C)]
#[derive(Copy, Clone)]
pub union btVector3__bindgen_ty_1 {
    pub mVec128: btSimdFloat4,
...
pub struct btQuadWord {
    pub __bindgen_anon_1: btQuadWord__bindgen_ty_1,
}
#[repr(C)]
#[derive(Copy, Clone)]
...
pub struct btSimdScalar {
    pub __bindgen_anon_1: btSimdScalar__bindgen_ty_1,
}
#[repr(C)]
#[derive(Copy, Clone)]
...
pub struct btSolverConstraint {
    ...
    pub m_appliedPushImpulse: btSimdScalar,
    pub m_appliedImpulse: btSimdScalar,
    pub m_friction: btScalar,
